...
\begin{itemize}
	...
	\Subitem Name very often trisyllabic: \textit{Índara} or perhaps \textit{Índr̥a}
...
\begin{itemize}
	...
	\Subitem {Epithets: \textit{Vr̥trahán}, \textbf{\textit{ánedya}}, \textit{magʰávan}, \textit{vajrín}/\textit{vájrivan}, \textit{ṡakrá} (cf.~Buddhism), \textit{ṡatá-kratu}}
...
\begin{frame} \frametitle{Índra in the Vedá}
\begin{itemize}
	\item Blemishless
	\item Uncriticized
	\item Primordial
...
\begin{frame} \frametitle{Índra after the Vedá}
\begin{itemize}
	\item Hedonistic
	\Subitem Drunken
...
\begin{itemize}
	...
	\item Those who accept the Vedá-s as supreme must necessarily reject post-Vedic interpretations of His role.
