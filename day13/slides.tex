...
\begin{itemize}
	...
	\Subitem {\textit{Annādáṡ ca vā́ idaṁ sárvam ánnaṁ ca}: ``The food-eater \& the food are everything here.'' (ṠB 11.1.16.19)}
...
\begin{itemize}
	...
	\Subsubitem {\textit{Svadʰā́ ca yátra tŕ̥ptiṡ ca / tátra mā́m amŕ̥taṁ kr̥dʰi} (R̥V 9.113.10)}
...
\begin{itemize}
	...
	\item \textit{Sákʰā su-ṡévav ádvayāḥ}: ``friend dear \& guileless''  (R̥V 1.187.3)
...
\begin{frame} \frametitle{Dietary restrictions in the Vedá-s}
\begin{itemize}
	...
	\Subitem But, exceptions for very special sacrifices, \& only for oxen \& barren (vaṡā́) kine
