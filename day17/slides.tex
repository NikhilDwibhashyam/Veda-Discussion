...
\begin{frame} \frametitle{Who are the Aṡvín-s?}
\begin{itemize}
	\item External view
	\Subitem Etymology straightforward this time: $\surd$\textit{aṡvá}
...
\begin{frame} \frametitle{Vedic descriptions of the Aṡvín-s}
\begin{itemize}
...
\begin{frame} \frametitle{Vedic mythemes about the Aṡvín-s}
\begin{itemize}
...
\begin{frame} \frametitle{The Aṡvín-s after the Vedá}
\begin{itemize}
...
\begin{frame} \frametitle{The Aṡvín-s outside Hinduism}
\begin{center}
	Anything?
\end{center}
\end{frame}
