...
\begin{itemize}
	...
	\Subitem Name very often trisyllabic: \textit{Rudará} or perhaps \textit{Rudr̥á}
...
\begin{itemize}
	...
	\item Beasts at the whim of weather: thus, \textit{paṡu-páti} (AV+)
	...
	\Subitem Not physician of the Gods, role taken by Aṡvín-s
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item In my \& most scholars' opinion: straightforwardly synonymous with Marút-s
	...
	\item Sons \& soldiers of \emph{the} Rúdra by the cow Pŕ̥ṡni
	\Subitem Interesting parellel to natural phænomena: storm-clouds
	\Subitem Literalist interpretation of Vedá
...
\begin{itemize}
	\item Not a person!
	\Subitem Not controversial to anyone who has read the Vedá
...
\begin{frame} \frametitle{Rudrá in the Vedá: an overview}
\begin{itemize}
...
\begin{frame} \frametitle{Rudrá after the Vedá}
\begin{itemize}
	...
	\item ``God of destruction'': not seen in Vedá (nor is trinity, of course)
...
\begin{itemize}
	...
	\item ``Paṡu-páti'' seal in IVC
	\item Lots of hogwash in my opinion
	\item Liṅga worship condemned in R̥V 7.21.5, \textit{ṡiṡná-deva}
